Aujourd'hui, pour commencer nous avons voulu regrouper ce qu'avait fait Loic la semaine dernière (le servomoteur), avec ce que j'avais fait (le step-moteur)
